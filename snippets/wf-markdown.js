...
wfx.wfnotesmd = (function(){
    ...
    var noteSelector = 'div.project.noted div.content';
    ...
    var warned = localStorage['wfx_md_been_warned_all'];
    if (typeof warned === 'undefined' || warned === null) {
        ...
        localStorage['wfx_md_been_warned_all'] = warned;
    }

    var runMarkdown = function(){};

    if (warned === 'false') {
        console.warn('localStorage value for wfx_md_been_warned_all is false. Aborting markdown.');
        runMarkdown = function(){return false}
    } else if (localStorage['wfx_md_been_warned_all'] === 'true') {
